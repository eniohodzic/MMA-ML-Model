...
class UFCScraper():
    ...
    def create_retries(self):
        # Retry Strategy for HTML request timeouts
    ...
    def scrape_fights(self):
        # Overhead function for scraping and writing all stats to CSV file
    ...
    def update(self, fight_stats, fighter_stats):
        # Update function for obtaining additional stats following completed fight cards
    ...
    def update_fight_stats(self, old_stats):
        # Internal function for scraping stats from event webpage and writing to DataFrame
    ...
    def update_fighter_details(self, fighter_urls, saved_fighters):
        # Internal function for scraping fighter webpage and writing to DataFrame
    ...
    def get_fight_card(self, url):
        # Obtain fight stats for an indivudal card
    ...
    def get_fight_stats(self, url):
        # Obtain fight stats for an indivudal fight 
    ...
    def get_all_fight_stats(self):
        # Obtain stats for all fights on all cards 
